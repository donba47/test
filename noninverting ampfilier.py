# -*- coding: utf-8 -*-
"""
Created on Sun Oct 11 07:52:41 2020
...
system = signal.lti([11], [1/571198.664,1])		# RC的Transfer function(s Domain)，1.44*10**-4為R*C
...
plt.hlines(-45,0,10e4,linestyle= '--',colors = "r")    #畫水平線(y,xstart,xend)
plt.vlines(10e4,-90,-45,linestyle= '--',colors = "r")   #畫垂直線(x,ystart,yend)                 	
plt.scatter(10e4,-45)
plt.annotate(r'         Cutoff frequency($f_b$)=6.283*10^4 (Hz)',#圖上註解
         xy=(10e4,-45), xycoords='data',xytext=(+1, -1),c="b",
             textcoords='offset points', fontsize=13,
             arrowprops=dict(arrowstyle='->', connectionstyle="arc3,rad=.2"))
plt.annotate(r'         at phase=-45(deg)',                        #圖上註解
         xy=(10e4,-45), xycoords='data', xytext=(+13, -13),c="b",
             textcoords='offset points', fontsize=13,
             arrowprops=dict(arrowstyle='->', connectionstyle="arc3,rad=.2"))
...
plt.vlines(100000,-40,17,linestyle= '--',colors = "r")       #畫垂直線(x,ystart,yend)             	
